...
export function VoiceInput({ className, onStart, onStop, isSaved = false }: VoiceInputProps) {
  ...
  let buttonStyle =
    "bg-[#34d399] text-gray-900 focus-visible:outline-emerald-500 hover:bg-emerald-400";
  let Icon = Mic;
  ...
  if (_listening) {
    ...
    buttonStyle =
      "bg-blue-100 text-blue-700 focus-visible:outline-blue-500 border-2 border-blue-300";
    Icon = Check;
