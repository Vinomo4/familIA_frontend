      ...
      >
        ...
        >
          <div className="flex justify-center">
            <div className="rounded-lg border bg-white px-4 py-1 font-mono text-xs shadow-sm">Precios</div>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 pt-2 text-sm font-medium">
            ...
            <Switch checked={isYearly} onCheckedChange={setIsYearly} className="data-[state=checked]:bg-zinc-900" />
            <span
              className={cn(
        ...
        <div className="relative grid gap-2 rounded-[1.75rem] border border-white/70 bg-white/55 p-3 shadow-[0_24px_70px_-45px_rgba(15,23,42,0.28)] backdrop-blur-sm md:grid-cols-2 md:gap-0">
            ...
            <div className="space-y-4">
              ...
              <div className="flex min-h-[72px] flex-col justify-center text-left">
                {isYearly ? (
                  ...
                  >
                    <span className="text-xs font-medium text-muted-foreground line-through">95,88 €</span>
                    <div className="relative flex items-end gap-1.5 text-xl text-muted-foreground">
                      <span className="-mb-0.5 text-4xl font-extrabold tracking-tighter text-foreground md:text-5xl">
                        79
                        <span className="align-super ml-0.5 text-xl font-bold tracking-normal md:text-2xl">,99</span>
                      </span>
                      <span className="-mb-0.5 text-4xl font-extrabold tracking-tighter text-foreground md:text-5xl">
                        €
                      </span>
                  ...
                  >
                    ...
                    <span className="-mb-0.5 text-4xl font-extrabold tracking-tighter text-foreground md:text-5xl">€</span>
          ...
          <Card className="relative flex w-full flex-col justify-between rounded-[1.4rem] border border-white/40 bg-white/45 px-4 pb-4 pt-5 shadow-none backdrop-blur-sm">
            <div className="z-10 space-y-4">
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="default" className="bg-zinc-900 px-2 py-0 text-[10px] text-white shadow-sm hover:bg-zinc-900">
                    Popular
                  </Badge>
                </div>
                <p className="text-xs leading-relaxed text-muted-foreground">
              ...
              <div className="flex min-h-[72px] flex-col justify-center text-left">
                {isYearly ? (
                  <motion.div
                    ...
                    className="flex flex-col text-left"
                  >
                    <span className="text-xs font-medium text-muted-foreground line-through">239,88 €</span>
                    <div className="relative flex items-end gap-1.5 text-xl text-muted-foreground">
                      <span className="-mb-0.5 text-4xl font-extrabold tracking-tighter text-foreground md:text-5xl">
                        199
                        <span className="align-super ml-0.5 text-xl font-bold tracking-normal md:text-2xl">,99</span>
            ...
            <div className="z-10 mt-8">
              <Button className="w-full cursor-pointer font-medium shadow-sm" onClick={() => onSelectPlan('pro')}>
                Empieza ahora
              </Button>
            </div>
          </Card>
